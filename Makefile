...
COSMO_CFLAGS = -O2 -std=gnu11 -D_COSMO_SOURCE -I$(COSMO_SRC) \
...
$(BUILDDIR)/entropy.o: src/entropy.c | $(BUILDDIR)
	$(CC) $(COSMO_CFLAGS) -c $< -o $@
...
.PHONY: clean distclean test test-tls test-registry
